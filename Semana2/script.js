...
// Estado actual del idioma (por defecto en inglés)
...
function changeLanguage() {
    ...
    // Aplicar las traducciones a los elementos correspondientes
    for (let key in translation) {
        const element = document.getElementById(key);
        if (element) {
            element.textContent = translation[key]; // Cambiar el texto si el elemento existe
        }
    }
...
// Asignar evento al botón de traducción
